...
export default function KLineChart({ data, loading, height = 500, buyMarker, sellMarker, pb, pe, initialZoomStart, initialZoomEnd }: KLineChartProps) {
  ...
  const hasInfoBar = pb != null || pe != null;
