...
def run(data):
    ...
    # stocks.ts_code 格式: "300308.SZ" → 提取数字部分 "300308"
    # index_constituents.ts_code: "300308"（原始数字码）
    raw_to_tscode = {}
    ts_code_to_name = {}
