...
from factors.trend.ma_support import compute as trend_ma_support_compute
...
def run(data: dict) -> list[dict]:
    ...
    for stock in stocks:
        ...
        # === 买入信号因子 ===
        buy_0 = trend_ma_support_compute(df, {"ma_period": 20, "tolerance": 1}) == 1
        buy_signal = (buy_0).astype(int)
